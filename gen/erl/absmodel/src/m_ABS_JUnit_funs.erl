...
'f_iterate'(Cog=#cog{ref=CogRef},V_tcs_0,Stack)->
    begin
        case V_tcs_0 of
            ...
            _ -> io:format("No match for tcs at abs/lang/abslang.abs:1409~n"), 
...
"/utf8>>]);
            _ -> io:format("No match for FnApp(tc) at abs/lang/abslang.abs:1416~n"), 
            exit(dataPatternMatchFailException)
        end
    end, begin
...
"/utf8>>]);
            _ -> io:format("No match for FnApp(tc) at abs/lang/abslang.abs:1423~n"), 
            exit(dataPatternMatchFailException)
        end
    end]), begin
...
"/utf8>>]);
            _ -> io:format("No match for FnApp(tc) at abs/lang/abslang.abs:1427~n"), 
            exit(dataPatternMatchFailException)
        end
    end]), <<"</testcase>
...
'f_iterateTS'(Cog=#cog{ref=CogRef},V_tss_0,Stack)->
    begin
        case V_tss_0 of
            ...
            _ -> io:format("No match for tss at abs/lang/abslang.abs:1439~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
...
'f_ttss'(Cog=#cog{ref=CogRef},V_data_0,Stack)->
    begin
        case V_data_0 of
            ...
            _ -> io:format("No match for data at abs/lang/abslang.abs:1403~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
...
'f_tcs'(Cog=#cog{ref=CogRef},V_data_0,Stack)->
    begin
        case V_data_0 of
            ...
            _ -> io:format("No match for data at abs/lang/abslang.abs:1404~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
...
'f_result'(Cog=#cog{ref=CogRef},V_data_0,Stack)->
    begin
        case V_data_0 of
            ...
            _ -> io:format("No match for data at abs/lang/abslang.abs:1406~n"), 
            exit(dataPatternMatchFailException)
        end
    end.
