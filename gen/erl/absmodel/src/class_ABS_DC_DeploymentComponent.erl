...
'm_acquire'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'cloudprovider'),null)) of
            ...
            put(vars, (get(vars))#{'tmp2105542914' => cog:create_task(C:get_val_internal(get(this), 'cloudprovider'),'m_acquireInstance',[O,[]],#task_info{method= <<"acquireInstance"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
             %% abs/lang/abslang.abs:1153--1153
            future:await(maps:get('tmp2105542914', get(vars)), Cog, [O,DC| Stack]),
            ok,
             %% abs/lang/abslang.abs:1153--1153
            put(vars, (get(vars))#{'result' := future:get_blocking(maps:get('tmp2105542914', get(vars)), Cog, [O,DC| Stack])});
            false ->         ok
        end,
...
'm_release'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        case (not cmp:eq(C:get_val_internal(get(this), 'cloudprovider'),null)) of
            ...
            put(vars, (get(vars))#{'tmp481833477' => cog:create_task(C:get_val_internal(get(this), 'cloudprovider'),'m_releaseInstance',[O,[]],#task_info{method= <<"releaseInstance"/utf8>>, creation={dataTime,builtin:currentms(Cog)}, proc_deadline=dataInfDuration},Cog)}),
             %% abs/lang/abslang.abs:1160--1160
            future:await(maps:get('tmp481833477', get(vars)), Cog, [O,DC| Stack]),
            ok,
             %% abs/lang/abslang.abs:1160--1160
            put(vars, (get(vars))#{'result' := future:get_blocking(maps:get('tmp481833477', get(vars)), Cog, [O,DC| Stack])});
            false ->         ok
        end,
 ...
 'amount' => V_amount_0 }),
    try
        ...
        case cmp:eq(C:get_val_internal(get(this), 'cpu'),dataInfRat) of
            true ->  %% abs/lang/abslang.abs:1208--1208
...
'm_advanceTimeBy1Tick'(O=#object{oid=Oid,cog=Cog=#cog{ref=CogRef,dcobj=DC}},Stack)->
    ...
    try
        ...
        put(this, C:set_val_internal(get(this), 'cpuhistory',[C:get_val_internal(get(this), 'cpuconsumed') | C:get_val_internal(get(this), 'cpuhistory')])),
         %% abs/lang/abslang.abs:1227--1227
        put(this, C:set_val_internal(get(this), 'cpuhistorytotal',case (not cmp:eq(C:get_val_internal(get(this), 'cpu'),dataInfRat)) of
         ...
         %% abs/lang/abslang.abs:1228--1228
        put(this, C:set_val_internal(get(this), 'bwhistory',[C:get_val_internal(get(this), 'bwconsumed') | C:get_val_internal(get(this), 'bwhistory')])),
         %% abs/lang/abslang.abs:1229--1229
        put(this, C:set_val_internal(get(this), 'bwhistorytotal',case (not cmp:eq(C:get_val_internal(get(this), 'bw'),dataInfRat)) of
         ...
         %% abs/lang/abslang.abs:1230--1230
